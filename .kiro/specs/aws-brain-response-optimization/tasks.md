...
- [x] 1. Add `CacheEntry` dataclass, `ResponseCache` class, and `build_cache_key()` function
  ...
  - [x] 1.1 Write property test for cache round-trip (Property 1)
  ...
  - [x] 1.2 Write property test for LRU eviction on capacity overflow (Property 4)
  ...
  - [x] 1.3 Write property test for cache key normalisation (Property 5)
...
- [x] 2. Add `LatencyStats` class
  ...
  - [x] 2.1 Write property test for latency always recorded (Property 10)
  ...
  - [x] 2.2 Write property test for get_stats() schema completeness (Property 11)
...
- [x] 3. Extend `BedrockClient.__init__()` with new config keys and validation
  ...
  - [x] 3.1 Write property test for missing config keys never raise exceptions (Property 12)
  ...
  - [x] 3.2 Write property test for invalid config values fall back to defaults (Property 13)
  ...
  - [x] 3.3 Write property test for non-positive cache config raises ValueError (Property 14)
...
- [x] 4. Implement `_build_prompt()` with length capping and single-turn format
  ...
  - [x] 4.1 Write property test for prompt length never exceeds configured limit (Property 9)
...
- [x] 5. Implement `_call_bedrock_with_timeout()` with retry and fallback
  ...
  - [x] 5.1 Write property test for fallback response format (Property 6)
  ...
  - [x] 5.2 Write property test for errors always return fallback (Property 7)
...
- [x] 6. Implement `_call_bedrock_streaming()` for incremental response delivery
...
- [x] 8. Wire cache, stats, and logging into `get_response()`
  ...
  - [x] 8.1 Write property test for cache hit bypasses Bedrock (Property 2)
  ...
  - [x] 8.2 Write property test for cache miss stores result (Property 3)
...
- [x] 9. Add module-level `get_stats()` function and verify singleton identity
  ...
  - [x] 9.1 Write property test for singleton client identity (Property 8)
...
- [x] 10. Create test file `src/cowrie/test/test_bedrock_optimization.py`
...
- [x] 11. Update `etc/cowrie.cfg.dist` with new `[bedrock]` config keys
